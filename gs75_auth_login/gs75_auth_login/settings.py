...
SECRET_KEY = 'django-insecure-hus#8lxm&-nf%*e@r#m51nv(b=z3js$vwmu@h8e+-fw7h-@92x'
...
ROOT_URLCONF = 'gs75_auth_login.urls'
...
WSGI_APPLICATION = 'gs75_auth_login.wsgi.application'
